...
class NavMenuController extends AdminBaseController
{
    ...
    public function index()
    {
        ...
        $arrResult = $objResult?$objResult->toArray():array();
        ...
        {
            $r['str_manage'] = '<a href="' . url("NavMenu/add", array("parent_id" => $r['id'],"nav_id"=>$r['nav_id'])) . '">添加子菜单</a> | <a href="'
                . url("NavMenu/edit", array("id" => $r['id'],"parent_id"=>$r['parent_id'],"nav_id"=>$r['nav_id'])) . '">修改</a> | <a class="js-ajax-delete" href="' . url("NavMenu/delete", array("id" => $r['id'])) . '">删除</a> ';
    ...
    public function add()
    {
        ...
        foreach ($arrResult as $r)
        {
            $r['str_manage'] = '<a href="' . url("NavMenu/add", array("parent_id" => $r['id'])) . '">添加子菜单</a> | <a href="'
                . url("NavMenu/edit", array("id" => $r['id'])) . '">修改</a> | <a class="J_ajax_del" href="'
                . url("NavMenu/delete", array("id" => $r['id'])) . '">删除</a> ';
            $r['status']   = $r['status'] ? "显示" : "隐藏";
        ...
        $this->assign("navcats",$objCats?$objCats->toArray():array());
    ...
    public function addPost()
    {
        ...
        if(empty($intParentId))
        {
            ...
            $arrParent = $objParent?$objParent->toArray():array();
    ...
    public function edit()
    {
        ...
        $arrNav = $objNav?$objNav->toArray():array();
    ...
    public function delete()
    {
        ...
        $count = $navMenuModel->where(array("parent_id" => $intId))->count();
        if ($count > 0) {
