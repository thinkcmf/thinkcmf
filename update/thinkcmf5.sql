...
) ENGINE=InnoDB AUTO_INCREMENT=98 DEFAULT CHARSET=utf8 COMMENT='权限授权表';

-- ----------------------------
--  Records of `cmf_auth_access`
-- ----------------------------
BEGIN;
INSERT INTO `cmf_auth_access` VALUES ('1', '2', 'admin/setting/default', 'admin_url'), ('2', '2', 'admin/menu/index', 'admin_url'), ('3', '2', 'admin/menu/add', 'admin_url'), ('4', '2', 'admin/menu/add_post', 'admin_url'), ('5', '2', 'admin/menu/listorders', 'admin_url'), ('6', '2', 'admin/menu/backup_menu', 'admin_url'), ('7', '2', 'admin/menu/export_menu_lang', 'admin_url'), ('8', '2', 'admin/menu/restore_menu', 'admin_url'), ('9', '2', 'admin/menu/getactions', 'admin_url'), ('10', '2', 'admin/menu/export_menu', 'admin_url'), ('11', '2', 'admin/menu/edit', 'admin_url'), ('12', '2', 'admin/menu/edit_post', 'admin_url'), ('13', '2', 'admin/menu/delete', 'admin_url'), ('14', '2', 'admin/menu/lists', 'admin_url'), ('15', '2', 'admin/menu/addpost', 'admin_url'), ('16', '2', 'admin/menu/editpost', 'admin_url'), ('17', '2', 'admin/menu/listorder', 'admin_url'), ('18', '2', 'admin/setting/password', 'admin_url'), ('19', '2', 'admin/setting/password_post', 'admin_url'), ('20', '2', 'admin/setting/passwordpost', 'admin_url'), ('21', '2', 'admin/setting/site', 'admin_url'), ('22', '2', 'admin/setting/site_post', 'admin_url'), ('23', '2', 'admin/route/index', 'admin_url'), ('24', '2', 'admin/route/add', 'admin_url'), ('25', '2', 'admin/route/add_post', 'admin_url'), ('26', '2', 'admin/route/edit', 'admin_url'), ('27', '2', 'admin/route/edit_post', 'admin_url'), ('28', '2', 'admin/route/delete', 'admin_url'), ('29', '2', 'admin/route/ban', 'admin_url'), ('30', '2', 'admin/route/open', 'admin_url'), ('31', '2', 'admin/route/listorders', 'admin_url'), ('32', '2', 'admin/setting/sitepost', 'admin_url'), ('33', '2', 'admin/mailer/index', 'admin_url'), ('34', '2', 'admin/mailer/index_post', 'admin_url'), ('35', '2', 'admin/mailer/active', 'admin_url'), ('36', '2', 'admin/mailer/active_post', 'admin_url'), ('37', '2', 'admin/mailer/test', 'admin_url'), ('38', '2', 'admin/mailer/indexpost', 'admin_url'), ('39', '2', 'admin/mailer/activepost', 'admin_url'), ('40', '2', 'admin/storage/index', 'admin_url'), ('41', '2', 'admin/storage/setting_post', 'admin_url'), ('42', '2', 'admin/setting/upload', 'admin_url'), ('43', '2', 'admin/setting/upload_post', 'admin_url'), ('44', '2', 'admin/setting/uploadpost', 'admin_url'), ('45', '2', 'admin/theme/index', 'admin_url'), ('46', '2', 'admin/theme/install', 'admin_url'), ('47', '2', 'admin/theme/uninstall', 'admin_url'), ('48', '2', 'admin/theme/installtheme', 'admin_url'), ('49', '2', 'admin/theme/update', 'admin_url'), ('50', '2', 'admin/theme/active', 'admin_url'), ('51', '2', 'admin/theme/files', 'admin_url'), ('52', '2', 'admin/theme/filesetting', 'admin_url'), ('53', '2', 'admin/theme/filearraydata', 'admin_url'), ('54', '2', 'admin/theme/filearraydataedit', 'admin_url'), ('55', '2', 'admin/theme/filearraydatadelete', 'admin_url'), ('56', '2', 'admin/theme/settingpost', 'admin_url'), ('57', '2', 'admin/theme/datasource', 'admin_url'), ('58', '2', 'admin/link/index', 'admin_url'), ('59', '2', 'admin/link/add', 'admin_url'), ('60', '2', 'admin/link/addpost', 'admin_url'), ('61', '2', 'admin/link/edit', 'admin_url'), ('62', '2', 'admin/link/editpost', 'admin_url'), ('63', '2', 'admin/link/delete', 'admin_url'), ('64', '2', 'admin/link/listorder', 'admin_url'), ('65', '2', 'admin/link/toggle', 'admin_url'), ('66', '2', 'admin/setting/clearcache', 'admin_url'), ('67', '2', 'admin/nav/index', 'admin_url'), ('68', '2', 'admin/nav/listorders', 'admin_url'), ('69', '2', 'admin/nav/delete', 'admin_url'), ('70', '2', 'admin/nav/edit', 'admin_url'), ('71', '2', 'admin/nav/edit_post', 'admin_url'), ('72', '2', 'admin/nav/add', 'admin_url'), ('73', '2', 'admin/nav/add_post', 'admin_url'), ('74', '2', 'admin/nav/addpost', 'admin_url'), ('75', '2', 'admin/nav/editpost', 'admin_url'), ('76', '2', 'admin/navmenu/index', 'admin_url'), ('77', '2', 'admin/navmenu/add', 'admin_url'), ('78', '2', 'admin/navmenu/addpost', 'admin_url'), ('79', '2', 'admin/navmenu/edit', 'admin_url'), ('80', '2', 'admin/navmenu/editpost', 'admin_url'), ('81', '2', 'admin/navmenu/delete', 'admin_url'), ('82', '2', 'admin/navmenu/listorder', 'admin_url'), ('83', '2', 'admin/slide/index', 'admin_url'), ('84', '2', 'admin/slideitem/index', 'admin_url'), ('85', '2', 'admin/slideitem/add', 'admin_url'), ('86', '2', 'admin/slideitem/addpost', 'admin_url'), ('87', '2', 'admin/slideitem/edit', 'admin_url'), ('88', '2', 'admin/slideitem/editpost', 'admin_url'), ('89', '2', 'admin/slideitem/delete', 'admin_url'), ('90', '2', 'admin/slideitem/ban', 'admin_url'), ('91', '2', 'admin/slideitem/cancelban', 'admin_url'), ('92', '2', 'admin/slideitem/listorder', 'admin_url'), ('93', '2', 'admin/slide/add', 'admin_url'), ('94', '2', 'admin/slide/addpost', 'admin_url'), ('95', '2', 'admin/slide/edit', 'admin_url'), ('96', '2', 'admin/slide/editpost', 'admin_url'), ('97', '2', 'admin/slide/delete', 'admin_url');
COMMIT;
...
CREATE TABLE `cmf_nav_menu` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8mb4 COMMENT='前台导航菜单表';

-- ----------------------------
--  Records of `cmf_nav_menu`
-- ----------------------------
BEGIN;
INSERT INTO `cmf_nav_menu` VALUES ('1', '1', '0', '1', '0', '首页', '', 'home', '', '0-1'), ('2', '1', '0', '1', '0', '列表演示', '', '{\"action\":\"portal\\/List\\/index\",\"param\":{\"id\":1}}', 'icon', '0-2'), ('9', '1', '2', '1', '0', '页面演示', '', '{\"action\":\"portal\\/Page\\/index\",\"param\":{\"id\":13}}', '', ''), ('10', '1', '2', '1', '10000', '联系我们', '', '{\"action\":\"portal\\/Page\\/index\",\"param\":{\"id\":14}}', '', ''), ('11', '1', '10', '1', '10000', 'test2', '', '{\"action\":\"portal\\/List\\/index\",\"param\":{\"id\":4}}', '', ''), ('12', '1', '0', '1', '10000', '发现', '', '{\"action\":\"portal\\/List\\/index\",\"param\":{\"id\":6}}', '', ''), ('13', '1', '12', '1', '10000', 'test', '', '{\"action\":\"portal\\/List\\/index\",\"param\":{\"id\":3}}', '', '');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cmf_portal_category` VALUES ('1', '0', '0', '1', '0', '10000', '列表演示', '列表演示', '', 'erq', 'qrew', 'qwer', 'list', 'article'), ('2', '0', '0', '1', '0', '10000', '瀑布流', '瀑布流', '', '', '', '', 'list', 'article'), ('3', '2', '0', '1', '1491959033', '10000', 'test', 'test', '', '', '', '', 'list', 'article'), ('4', '1', '0', '1', '1491959031', '10000', 'test2', '', '', '', '', '', 'list', 'article'), ('5', '4', '0', '1', '1491889946', '10000', 'test3', '', '', '', '', '', 'list', 'article'), ('6', '2', '0', '1', '0', '10000', '发现', '发现', '', '发现', '地', '地', 'list', 'article');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cmf_recycle_bin` VALUES ('1', '6', '1490923089', 'portal_category', 'asf'), ('2', '7', '1490923091', 'portal_category', 'ddd'), ('3', '8', '1490923093', 'portal_category', 'testddd'), ('4', '2', '1490923104', 'portal_category', '瀑布流'), ('5', '3', '1491024623', 'portal_post', 'ddd'), ('6', '5', '1491889946', 'portal_category', 'test3'), ('7', '4', '1491959031', 'portal_category', 'test2'), ('8', '3', '1491959033', 'portal_category', 'test');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `cmf_slide_item` VALUES ('2', '1', '0', '22', 'test1', '20170411/638dfcac5df61a10f49c78d046953995.png', 'dd', 'dd', 'd', null), ('3', '1', '1', '10000', '啊发水电费FASDF', '', '', '', '艺术硕士', null);
COMMIT;
