...
class Tree
{
     ...
     */
    public function getTreeViewMenu($myId, $effected_id = 'example', $str = "<span class='file'>\$name</span>", $str2 = "<span class='folder'>\$name</span>", $showlevel = 0, $ul_class = '', $li_class = '', $style = 'filetree ', $currentlevel = 1, $recursion = false, $dropdown = 'hasChild')
    {
        $child = $this->getChild($myId);
        if (!defined('EFFECTED_INIT')) {
            $effected = ' id="'.$effected_id.'"';
